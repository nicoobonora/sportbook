...
export function ClubForm({ club }: { club?: Club }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      claim_status: club?.claim_status || "claimed",
    },
  })
        ...
        <TabsContent value="identity">
          <Card>
            <CardContent className="space-y-4 pt-6">
              ...
              {/* Claim status — solo in modifica */}
              {isEditing && (
                <div className="space-y-2">
                  <Label htmlFor="claim_status" className="flex items-center gap-1.5">
                  ...
                  >
                    <option value="unclaimed">Non reclamato</option>
                    <option value="pending">In attesa di verifica</option>
                    <option value="claimed">Verificato</option>
                  </select>
                  <p className="text-xs text-muted-foreground">
                    I club non reclamati non possono ricevere prenotazioni e appaiono in grigio sulla mappa.
                  </p>
                </div>
              )}
            </CardContent>
